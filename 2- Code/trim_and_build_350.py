...
# Master 350-Shot calibrated production dataset
# Duration: exactly 11 minutes 12 seconds (672s)
# Total characters: ~11,200 characters (at 1000 chars = 60s)
# Total shots: 350 shots (avg 32 chars / 1.92s per cut)

# Let's define the 350 shots across the 7 Acts with crisp, fast-paced voiceover phrases
# Format: (text, visual_description, prompt_subject)

shots = [
    # --- ACT 1: THE MODERN GRID VS THE OPEN HORIZON (00:00 - 01:20) [45 shots, ~1,340 chars] ---
    ("Right now, your existence", "Extreme close-up of a digital alarm clock.", "digital alarm clock flashing red 06:30 AM numbers"),
    ("is sliced into little colored boxes", "Smartphone calendar packed with multicolored meeting blocks.", "smartphone screen with tightly packed calendar schedule blocks"),
    ("on a glowing screen.", "Blue light from phone shining onto a dark pillow.", "cold blue smartphone light illuminating a dark bedroom pillow"),
    ("Before your feet hit the floor,", "Stick figure swinging legs out of bed onto wooden floor.", "tired stick figure swinging legs out of bed onto bedroom floor"),
    ("you look at a glass rectangle", "Hand gripping glowing smartphone screen.", "hand holding glowing smartphone screen in dark room"),
    ("to see who owns your morning,", "Notification box showing urgent corporate email.", "urgent email notification popup with exclamation mark"),
    ("who owns your afternoon,", "Calendar app showing back-to-back meetings.", "calendar app showing continuous meetings from morning to evening"),
    ("and how many minutes you get for lunch.", "A lonely sandwich next to a ticking desk clock.", "plastic wrapped sandwich next to ticking desk clock"),
    ("You sprint through honking traffic,", "Stick figure gripping steering wheel in bumper-to-bumper traffic.", "stick figure gripping car steering wheel in traffic jam"),
    ("cram onto a packed subway train,", "Stick figures squeezed tightly together in subway car.", "crowded subway car with stick figures staring down at phones"),
    ("and trade ten hours of your life", "Stick figure typing hunched over office laptop.", "stick figure typing at office cubicle under fluorescent lights"),
    ("answering messages from strangers.", "Floating unread message bubbles overwhelming a stick figure.", "stressed stick figure surrounded by floating unread chat icons"),
    ("And tonight, before you sleep,", "Stick figure lying in bed staring at phone.", "stick figure in bed in dark room looking at phone screen"),
    ("you will set that same machine", "Close-up of finger hovering over alarm toggle switch.", "finger hovering over digital smartphone alarm toggle"),
    ("to scream at you again.", "Alarm toggle sliding green for 06:00 AM.", "smartphone screen setting alarm toggle with green checkmark"),
    ("Now, rewind forty-five thousand years.", "Screen wipe: bedroom dissolves into prehistoric valley.", "dissolving transition from modern clock to prehistoric river valley"),
    ("A man wakes in the morning light.", "Paleolithic hunter opening eyes peacefully on grassy ridge.", "prehistoric stick figure opening eyes peacefully at golden dawn"),
    ("No alarm. No schedule. No clock.", "Open horizon with pink clouds and river mist.", "panoramic savannah sunrise landscape with gentle river mist"),
    ("Nowhere he is required to be.", "Hunter standing on ridge looking at endless wilderness.", "prehistoric stick figure standing free on cliff edge looking at valley"),
    ("He owns a flint spear, two hides,", "Isolated drawing of flint spear and folded animal pelts.", "isolated knapped flint spear and folded furry animal pelts"),
    ("and a small morning fire.", "Smoking campfire in a ring of river stones.", "small morning campfire smoking inside ring of river stones"),
    ("He stretches his arms wide,", "Hunter yawning and stretching arms toward morning sun.", "hunter stretching arms wide and yawning happily in warm sun"),
    ("and asks a question you cannot ask:", "Hunter touching chin thoughtfully, gazing at clouds.", "thoughtful hunter with hand on chin looking up at sky"),
    ("What do I want to do today?", "Thought bubble showing fishing, hiking, or sleeping.", "thought bubble showing three choices: fishing, hiking, resting"),
    ("Now, your modern brain fights this.", "Modern stick figure sitting on sofa with crossed arms.", "modern stick figure with crossed arms looking skeptical"),
    ("You think: Sure, that sounds nice,", "Thought bubble showing stick figure running from lion.", "stick figure imagining being chased by cartoon roaring lion"),
    ("but they died at twenty-five,", "Doodle of shivering stick figure in icy cave.", "cartoon stick figure shivering in dark cave with icicles"),
    ("froze in caves, and starved.", "Stick figure looking into an empty wooden bowl.", "stick figure looking down into empty wooden bowl hungry"),
    ("That is the story we tell ourselves.", "Open history book stamped with red MYTH stamp.", "old open textbook with red ink stamp saying myth"),
    ("The myth that history is a straight line", "Tilted ramp showing evolution from ape to office worker.", "evolution ramp diagram from ape to stick figure at computer"),
    ("from ancient misery to modern paradise.", "Modern worker looking stressed surrounded by gadgets.", "modern stick figure at desk surrounded by appliances looking stressed"),
    ("We tell ourselves forty hours of work", "Stick figure running on a hamster wheel inside a clock.", "tired stick figure running inside giant ticking clock gear"),
    ("is the price of escaping ancient pain.", "Paper bill stamped 'PAYMENT FOR SURVIVAL'.", "paper receipt stamped with bold red text payment for survival"),
    ("We assume ancient humans were beasts", "Primitive ape-like figure scratching head in mud.", "primitive stick figure scratching head looking confused in mud"),
    ("with no time to sit in peace.", "Stick figure running in panic between falling rocks.", "stick figure running between falling rocks in panic"),
    ("We think technology set us free.", "Smiling lineup of phone, microwave, and laptop.", "smiling row of modern gadgets: phone, microwave, laptop"),
    ("We think progress bought us leisure.", "Empty hammock on beach with 'UNAVAILABLE' tag.", "beach hammock between palm trees with red unavailable tag"),
    ("And we wear exhaustion like a medal.", "Stick figure wearing gold medal labeled 'BURNOUT'.", "stick figure proudly wearing medal that reads burned out"),
    ("Because admitting the truth is terrifying:", "Modern person staring into empty coffee cup in shock.", "modern stick figure staring into empty coffee mug with wide eyes"),
    ("a caveman may have been freer than you.", "Person looking through prison bars at free hunter on hill.", "person looking through window bars at free hunter on grassy hill"),
    ("That breaks society's promise.", "Golden parchment contract tearing down the middle.", "golden parchment contract tearing in half down center"),
    ("So we cling to the myth of brutality.", "Office worker hiding behind shield labeled 'EXCUSES'.", "office worker hiding behind wooden shield labeled excuses"),
    ("We tell ourselves they had no life.", "Gravestone marked: 'NO LEISURE, ONLY TOIL'.", "stone gravestone marked with text no free time only toil"),
    ("But when archaeologists dig into the dirt,", "Archaeologist kneeling in trench using brush and trowel.", "archaeologist in sun hat using small trowel in dirt trench"),
    ("the bones tell the exact opposite story.", "Two ancient fossil graves uncovered in dry earth strata.", "two exposed ancient human skeletons in archaeological trench"),

    # --- ACT 2: FORENSIC AUTOPSY — THE DIRT DOESN'T LIE (01:20 - 03:00) [52 shots, ~1,670 chars] ---
    ("Dirt doesn't lie. Look at the bones.", "Close-up of fossilized human bones in excavated sediment.", "macro shot of clean fossil human bones in archaeological trench"),
    ("In the late twentieth century,", "Laboratory table with magnifying lenses and ancient skulls.", "bioarchaeology lab table with calipers and prehistoric skulls"),
    ("bioarchaeologists ran forensic comparisons", "Two display tables labeled 'Hunter' and 'Farmer'.", "two clean display tables labeled hunter-gatherer and early farmer"),
    ("on ancient skeletons across the Fertile Crescent.", "Map of Middle East highlighting Tigris and Euphrates rivers.", "map of ancient Mesopotamia with highlighted river valleys"),
    ("At dig sites like Abu Hureyra in Syria,", "Excavation grid diagram with numbered burial squares.", "detailed excavation trench diagram with numbered burial flags"),
    ("they found the exact centuries", "Timeline chart showing arrow from spear to sickle icon.", "timeline chart showing spear icon transitioning to sickle icon"),
    ("where hunting stopped and farming began.", "Plowed brown dirt field with small green seedling rows.", "plowed agricultural field with small seedling wheat sprouts"),
    ("Comparing those two groups side by side", "Split screen showing two complete skeletons horizontally.", "split screen showing two human skeletons laid out on white canvas"),
    ("reveals something genuinely shocking.", "Scientist peering through magnifying glass with wide eyes.", "stick figure scientist looking through magnifying glass with shock"),
    ("Skeleton A belonged to a Paleolithic hunter.", "Full anatomical view of tall, robust Skeleton A.", "anatomical doodle of robust tall skeleton with straight spine"),
    ("He lived thirty thousand years ago.", "Silhouette of hunter walking along steppe carrying spear.", "silhouette of hunter carrying spear walking along open ridge"),
    ("He stood nearly five foot eleven inches tall.", "Height chart showing hunter reaching 5'11 mark.", "height measurement chart showing tall hunter reaching 5 foot 11"),
    ("His bone density was extraordinary—", "Cross-section of thigh bone showing ultra-thick outer wall.", "cross-section diagram of human femur showing dense thick bone walls"),
    ("equal to a modern Olympic decathlete.", "Stick figure decathlete sprinting with muscular lines.", "athletic stick figure running showing muscular strength lines"),
    ("His skeleton was shaped by varied movement:", "Three icons: hiking rocky hills, wading rivers, climbing.", "three icons showing hiking rocks, wading river, climbing tree"),
    ("walking uneven terrain and tracking game.", "Hunter balancing gracefully on fallen log over gorge.", "prehistoric stick figure balancing on fallen log over river"),
    ("His joints show no repetitive stress damage.", "Close-up of knee joint showing smooth cartilage surfaces.", "anatomical illustration of smooth clean knee joint bone surface"),
    ("And when researchers examined his jaws,", "Close-up of hunter skull jaws with wide dental arch.", "skull jaw showing wide dental arch with full set of teeth"),
    ("they found practically zero dental cavities.", "Clean white molar tooth sparkling with shine glints.", "isolated clean molar tooth doodle with sparkle shine lines"),
    ("Not because he brushed or flossed,", "Toothbrush and floss roll crossed out with red X.", "toothbrush and dental floss crossed out with red hand-drawn X"),
    ("but because he ate no refined starch or sugar.", "Wild diet arranged: walnuts, blackberries, roasted venison.", "arranged wild diet: walnuts, blackberries, lean venison, roots"),
    ("His mouth was naturally healthy.", "Microscopic doodle of balanced friendly oral bacteria.", "microscopic doodle of friendly balanced oral bacteria cells"),
    ("Now turn your attention to Skeleton B.", "Pan to Skeleton B: smaller frame, hunched spine.", "anatomical illustration of smaller hunched skeleton"),
    ("This is an early Neolithic wheat farmer", "Early farmer kneeling in mud, grinding stone on slab.", "stick figure farmer kneeling in mud pushing heavy grinding stone"),
    ("from the exact same valley thousands of years later.", "Same river valley cleared of trees, turned to muddy plots.", "river valley with cleared forest replaced by bare tilled plots"),
    ("He is four inches shorter than his ancestor.", "Height chart showing farmer dropping to 5'6 mark.", "height comparison chart showing farmer skeleton dropping four inches"),
    ("His spine tells a brutal story.", "Close-up of vertebrae showing crushed discs and spurs.", "close-up of spinal vertebrae showing crushed discs and bone spurs"),
    ("Female skeletons from these early villages", "Female farmer kneeling on knees over stone saddle-quern.", "female stick figure kneeling bending over stone grain quern"),
    ("show permanent arthritis in the toes and knees", "Close-up of foot bones showing curled arthritic toe joints.", "doodle of human foot bones showing curled arthritic toe joints"),
    ("from kneeling six to eight hours every day,", "Clock dial sweeping 8 hours while figure remains kneeling.", "clock face with shadow hand sweeping 8 hours over kneeling figure"),
    ("grinding wheat grains on stone slabs.", "Hands pushing stone pestle across hollow stone slab.", "hands pushing stone pestle across hollow stone grinding grain"),
    ("Her collarbones are grooved from heavy loads.", "Collarbone showing stress grooves from carrying sacks.", "diagram of collarbone showing wear grooves from hauling loads"),
    ("And his teeth? A nightmare of rot.", "Farmer skull jaws open showing dark decayed cavities.", "skull jaw close-up showing decayed black cavities and abscesses"),
    ("Sticky grain porridge coated his teeth,", "Boiled grain porridge bubbling in ceramic clay pot.", "boiling sticky wheat porridge bubbling in ceramic clay pot"),
    ("feeding bacteria that ate into the nerve pulp.", "Cartoon bacteria chipping into tooth enamel with pickaxes.", "cartoon bacteria bugs with pickaxes chipping away at tooth"),
    ("Dental abscesses ate straight through jawbones.", "Cross section of jaw showing painful dark abscess pocket.", "anatomical cross section of jaw showing painful bone abscess"),
    ("His skull is full of tiny porous pits,", "Inner eye socket bone showing spongy sieve-like pits.", "skull eye socket close-up showing porotic hyperostosis bone pits"),
    ("a condition called porotic hyperostosis,", "Medical label pointing to bone porosity: 'Nutritional Stress'.", "medical label pointing to skull bone pitting reading nutritional stress"),
    ("caused by chronic iron-deficiency anemia.", "Bowl of gray porridge next to hollow-cheeked farmer.", "bowl of plain gray grain porridge next to malnourished farmer"),
    ("Farming was not an upgrade in health.", "Cracked stone monument of wheat stalks crumbling down.", "cracked stone monument with wheat stalk carving crumbling to dust"),
    ("It was a physical catastrophe.", "Farmer standing in field clutching aching lower back.", "stick figure farmer clutching sore lower back with pain lightning lines"),
    ("The hunter ate hundreds of diverse wild foods,", "Wheel diagram of 80 wild plants, seeds, fruits, meats.", "circular wheel chart showing colorful variety of wild foods"),
    ("rich in vitamins, minerals, and protein.", "Vibrant energetic stick figure leaping over log in forest.", "energetic stick figure leaping gracefully over log in forest"),
    ("He had dense bones and straight joints.", "Hunter standing tall and proud in sunshine with clear face.", "tall prehistoric stick figure smiling with healthy face in sunshine"),
    ("What about lifespan? Infant mortality was high.", "Mother holding baby wrapped in fur near hearth fire.", "mother holding baby wrapped in fur sitting near hearth fire"),
    ("Many children died before age five,", "Small gentle grave mound marked with wildflowers on hill.", "small gentle grave mound marked with wild field flowers"),
    ("which dragged down the statistical average.", "Chalkboard showing average calculation equation.", "chalkboard showing statistical average calculation with chalk"),
    ("But if an ancient hunter reached adulthood,", "Healthy middle-aged hunter running alongside deer.", "strong middle-aged stick figure running with steady stride"),
    ("he routinely lived into his sixties and seventies,", "Elderly hunter with white beard telling story to listeners.", "wise elder stick figure with white beard gesturing at campfire"),
    ("muscular, active, and carrying all his teeth.", "Elder carving wooden bowl with steady skilled hands.", "hands of elder skillfully whittling smooth wooden bowl with flint"),
    ("So if he wasn't dying young in squalor,", "Modern stick figure tapping chin thoughtfully with lightbulb.", "modern stick figure tapping chin thoughtfully with lightbulb"),
    ("what did a normal day actually look like?", "Sunrise over winding river valley with stylized sun rays.", "sunrise over river valley with stylized sun rays across canvas")
]

# We will concatenate and print progress
print(f"Act 1: {len(shots)} shots loaded...")
...
# Combine all acts
all_shots = shots + act3 + act4 + act5 + act6 + act7
