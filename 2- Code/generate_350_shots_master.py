...
# Master definition of the 350-shot fast-paced production database
# Total target: ~340 to 360 shots, ~11,200 characters (~11m 12s at 1000 chars/min)

shots_raw = [
    # ==========================================
    # ACT 1: THE MODERN GRID VS THE OPEN HORIZON (00:00 - 01:20)
    # Target: ~42 shots, ~1330 characters (~80 seconds)
    # ==========================================
    ("Right now, your entire existence is sliced", "Close-up of a glowing digital alarm clock flashing harsh red digits on a nightstand.", "digital alarm clock flashing red 06:30 AM numbers on a dark wooden nightstand"),
    ...
    # ==========================================
    # ACT 2: FORENSIC AUTOPSY — THE DIRT DOESN'T LIE (01:20 - 03:00)
    # Target: ~52 shots, ~1670 characters (~100 seconds)
    # ==========================================
...
print(f"Loaded {len(shots_raw)} shots so far...")
''')
print("generate_350_shots_master.py created")
